extends "res://objects/effect/pickup_effect.gd"
# MiSTer patch for objects/effect/pickup_effect.gd (gold, mega gold and bonus
# pickup effects: AnimatedSprite2D, one-shot "active" animation, then free).
